...
?>
<h4 class="text-center">Weekly Sale Report</h4>
<br>
<table class="table table-striped">
    ...
    if(count($bookings) == 0) {
        echo("<tr><td colspan='7' class='text-center'>No Sale Found</td></tr>");
    }
    ...
    echo("<tr><td colspan='14' class='h6 font-weight-bold'>Total Sale: $sum PKR </td></tr>");
